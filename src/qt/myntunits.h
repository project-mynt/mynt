...
#ifndef MYNT_QT_MYNTUNITS_H
#define MYNT_QT_MYNTUNITS_H
...
/** Mynt unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MyntUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MyntUnits(QObject *parent);

    /** Mynt units.
      @note Source: https://en.mynt.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MYNT,
...
typedef MyntUnits::Unit MyntUnit;

#endif // MYNT_QT_MYNTUNITS_H
