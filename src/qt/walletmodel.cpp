...
WalletModel::SendCoinsReturn WalletModel::sendCoins(WalletModelTransaction &transaction)
{
...

    {
        ...
        for (const SendCoinsRecipient &rcp : transaction.getRecipients())
        {
            ...
            else if (!rcp.message.isEmpty()) // Message from normal mynt:URI (mynt:123...?message=example)
...
//    questionString.append(MyntUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), oldFee));
//    questionString.append("</td></tr><tr><td>");
//    questionString.append(tr("Increase:"));
//    questionString.append("</td><td>");
//    questionString.append(MyntUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), newFee - oldFee));
//    questionString.append("</td></tr><tr><td>");
//    questionString.append(tr("New fee:"));
//    questionString.append("</td><td>");
//    questionString.append(MyntUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), newFee));
