...
#ifndef MYNT_QT_MYNTGUI_H
#define MYNT_QT_MYNTGUI_H
...
/**
  Mynt GUI main class. This class represents the main window of the Mynt UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MyntGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MyntGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~MyntGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a mynt wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
