...
#include "config/mynt-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatMyntURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + MyntUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatMyntURI(info));
}
