...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<MyntAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_mynt-qt -platform xcb      # Linux
//     src/qt/test/test_mynt-qt -platform windows  # Windows
//     src/qt/test/test_mynt-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = MyntUnits::formatWithUnit(unit, balance, false, MyntUnits::separatorAlways);
    ...
    // Amount input
    MyntAmountField* amountInput = receiveCoinsDialog.findChild<MyntAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: mynt:")) != -1);
