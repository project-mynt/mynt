...
#ifndef MYNT_TEST_SCRIPTNUM10_H
#define MYNT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Mynt Core 0.10.0, for cross-comparison.
 */
public:
