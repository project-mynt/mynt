...
class BIP66Test(MyntTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # myntd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and myntd produces more specific reject
            # reasons.
