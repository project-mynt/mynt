...
# TestNode: A peer we use to send messages to myntd, and store responses.
...
class CompactBlocksTest(MyntTestFramework):
    ...
    # This test actually causes myntd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that myntd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for myntd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # myntd will not send blocktxn responses for blocks whose height is
