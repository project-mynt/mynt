...
class TestMyntCli(MyntTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `mynt-cli getinfo`")
        ...
        self.log.info("Compare responses from `mynt-cli -getinfo` and the RPCs data is retrieved from.")
