...
class TxnMallTest(MyntTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 MYNT:
        ...
        # First: use raw transaction API to send 1240 MYNT to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 MYNT coin each
        ...
        # Node0's balance should be starting balance, plus 50MYNT for another
        ...
        # Node0's total balance should be starting balance, plus 100MYNT for 
