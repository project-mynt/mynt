...
By default, myntd will dump mempool on shutdown and
...
class MempoolPersistTest(MyntTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give myntd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent myntd from writing mempool.dat to disk. Verify that `savemempool` fails")
