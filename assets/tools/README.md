...
### IPFS Pinner
Loops through blocks and transactions and pins asset issuance meta-data and then monitors myntd transactions for new ipfs metadata via zmq.
...
* Run myntd or mynt-qt with parameter to use zmq: ```-zmqpubrawtx=tcp://127.0.0.1:28766```
