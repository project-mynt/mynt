...
find ${DISTNAME}/bin -type f -executable -exec ../mynt/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../mynt/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/mynt/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/mynt/depends/SDKs/MacOSX10.11.sdk.tar.gz
