...
- MyntMiner : Generates mynts (if wallet is enabled).
...
- src/libsecp256k1
  - Upstream at https://github.com/mynt-core/secp256k1/ ; actively maintaned by Core contributors.

- src/crypto/ctaes
  - Upstream at https://github.com/mynt-core/ctaes ; actively maintained by Core contributors.
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:mynt/mynt.git
