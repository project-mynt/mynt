Mynt Core version *2.1.0* is now available!!
==============

  <https://github.com/project-mynt/Mynt/releases/tag/v2.1.0>
...
Mynt Core has been tested with macOS 10.14 Mojave, but it is recommended that developers
...
Changelog available here: <https://github.com/project-mynt/Mynt/commits/release_2.1.0>
...
- Most importantly - The Mynt Community!
- Tron Black
- Jesse Empey
- Jeremy Anderson
- Corbin Fox
