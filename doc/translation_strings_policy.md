...
This document provides guidelines for internationalization of the Mynt Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `mynt_en.ts` remains unchanged.
